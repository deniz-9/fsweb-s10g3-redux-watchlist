...
import { addFavorite, nextMovie, prevMovie, firstMovie } from "./actions/actions"; 
      ...
      <Switch>
        <Route exact path="/">
          ...
          <div className="flex gap-3 justify-end py-3">
            ...
            <button onClick={() => handleAddFavourite(movies[sira])} className="select-none px-4 py-2 bg-blue-700 hover:bg-blue-600 text-white">
              Listeme ekle
            </button>
          </div>
        </Route>
